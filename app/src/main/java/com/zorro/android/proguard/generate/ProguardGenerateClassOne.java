package com.zorro.android.proguard.generate;
...
/**
 * Created by Zorro 2024/11/28
 * JAVA生成混淆字典
 */
public class ProguardGenerateClassOne {

    //字典样本
    private static List<String> SOURCE = Arrays.asList("i", "I", "1", "l", "L", "0", "o", "O");
    //    private static List<String> SOURCE = Arrays.asList("i", "I", "1", "l", "L");
    //    private static List<String> SOURCE = Arrays.asList("0", "o", "O");
    //字典行数
    private static int LENGTH = 7512;
    //输出路径
    private static final String ROOT_PATH = System.getProperty("user.dir") + "/app/";
    //输出名称
    private static final String FILE_NAME = "comm_dict.txt";
